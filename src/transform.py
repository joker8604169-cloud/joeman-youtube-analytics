...
# 人工抽樣驗證的結果（2026-07 執行，共核對 103 支）。
# 這些數字無法由程式自動算出，必須由 src.sponsor_evaluate 產出後填回。
AUDIT = {
    "長片精確率": "96.8%（95% 信賴區間 83.8–99.4%）",
    "長片召回率": "85.3%（95% 信賴區間 64.6–95.4%）",
    "Shorts召回率": "14.7%（95% 信賴區間 10.5–21.8%）",
